...
const Brands = ({ brands,mode }) => {
    ...
    return (
        <div className="max-w-[1440px] mx-auto lg:mt-20  px-3 py-2 lg:px-10 lg:py-10  ">
            <h1 data-aos="fade-down" className={`text-4xl lg:text-6xl font-bold ${mode} text-center mb-4`}> Top Brands </h1>
            ...
            <div className=" grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                ...
                {
                    brands.map(brand => <Brand key={brand._id} mode={mode} brand={brand}></Brand>)
                }
